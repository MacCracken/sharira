# Sharira — Claude Code Instructions

## Project Identity

**Sharira** (शरीर — Sanskrit: body, physical form) — physiology engine for skeletal structures, musculature, locomotion, and biomechanics
...
kiran (game engine), soorat (renderer), jantu (creature AI), bhava (emotion/personality), impetus (physics)

**Depends on**: hisab (math primitives)

**Modules**: skeleton, joint, muscle, gait, biomechanics, preset, logging (optional)
